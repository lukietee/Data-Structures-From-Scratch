...
listNode::listNode(int id, int inv, listNode* tempNext, listNode* tempPrevious)
{
    myId = id;
    myInv = inv;
    next = tempNext;
...
{
    listNode* newNode = new listNode(id, inv, nullptr, nullptr);
    ...
    else if (temp.first->myId > id)
    {
        ...
        {
            listNode* newerNode = new listNode(id, inv, temp.first, nullptr);
    ...
    {
        listNode* newterNode = new listNode(id, inv, nullptr, temp.last);
    ...
    else
    {
        ...
        listNode* newestNode = new listNode(id, inv, front, back);
